 ...
 * @author memorykghs
 */
public class BCHAGGRE001ItemReader2 implements ItemReader<AggregateItemReader<Car>> {

    @Autowired
    private CarRepo carRepo;

    @Override
    public AggregateItemReader<Car> read() throws Exception, UnexpectedInputException, ParseException, NonTransientResourceException {
