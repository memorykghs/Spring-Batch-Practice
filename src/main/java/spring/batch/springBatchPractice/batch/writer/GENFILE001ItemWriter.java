...
public class GENFILE001ItemWriter extends FlatFileItemWriter {

    private LineAggregator<ItemInfo> lineAggregator;

    private LineAggregator<ItemInfo> headerLineAggregator = new DelimitedLineAggregator<>();
