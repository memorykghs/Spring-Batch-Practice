 ...
 * @author memorykghs
 */
public class BCHAGGRE001WriterListener implements ItemWriteListener<ItemInfoDto> {
    
    private static final Logger LOGGER = LoggerFactory.getLogger(BCHAGGRE001WriterListener.class);
    ...
    public void onWriteError(Exception ex, List<? extends ItemInfoDto> items) {
        LOGGER.error("BCHAGGRE001: 寫入資料失敗", ex);
    }
